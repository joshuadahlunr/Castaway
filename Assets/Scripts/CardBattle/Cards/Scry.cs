...
namespace CardBattle {
    ...
    /// <list type="bullet">
    ///     <item><description><c>duration</c> (utility): How many turns the negative effect lasts</description></item>
    ///     <item><description><c>reduction</c> (utility): How much to worsen every property of the card by</description></item>
    /// </list>
    /// </remarks>
